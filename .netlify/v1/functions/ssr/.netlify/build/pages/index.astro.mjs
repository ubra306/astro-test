...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  var aiSummary = await import('../chunks/ai-summary_D6-wkLU9.mjs').then(n => n._);
  const summary = await aiSummary.chatWithAzureOpenAI([
    {
      role: "user",
      content: `Fasse die wichtigsten Informationen dieses Fahrzeugs f\xFCr einen Interessenten in einem Absatz zusammen. Antworte auf Deutsch. Fahrzeugdaten: ${JSON.stringify(vehicle)}`
    }
  ]);
