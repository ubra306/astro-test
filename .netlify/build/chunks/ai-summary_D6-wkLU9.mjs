...
const API_URL = "https://aif-it-talents.cognitiveservices.azure.com/";

const schema = {"API_URL":{"context":"client","access":"public","optional":true,"type":"string"},"PORT":{"context":"server","access":"public","default":4321,"type":"number"},"API_KEY":{"context":"server","access":"secret","type":"string"}};
